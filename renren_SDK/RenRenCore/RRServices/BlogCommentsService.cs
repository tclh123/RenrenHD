...
{
    class BlogCommentsService : RRServiceBase<long, BlogCommentEntity>
    {
        /// <summary>
        /// Singleton property
        /// </summary>
        ...
        /// <returns></returns>
        public async Task<RenRenResponseArg<BlogCommentEntity>> RequestBlogCommentsByUid(int uid, long blogId, int page, int pageSize, string password)
        {
            RenRenResponseArg<BlogCommentEntity> resp = await RequestById(blogId, uid, page, pageSize, password);
            return resp;
        }
        ...
        protected async override Task<RenRenResponseArg<BlogCommentEntity>> DoRequestById(long id, params object[] args)
        {
            ...
            RenRenResponseArg<BlogCommentEntity> resp = await API.Renren3GApi.GetBlogComment(seesionKey, secrectKey, uid, id, page, pageSize, password);
            return resp;
        }
