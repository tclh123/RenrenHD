...
{
    class LatestVisitorService : RRServiceBase<int, VisitorsEntity>
    {
        /// <summary>
        /// Singleton property
        /// </summary>
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<RenRenResponseArg<VisitorsEntity>> RequestMyVisitorList(int page = -1, int pageSize = -1)
        {
            RenRenResponseArg<VisitorsEntity> resp = await Request(page, pageSize);
            return resp;
        }
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<RenRenResponseArg<VisitorsEntity>> RequestVisistorListByUid(int uid, int page = -1, int pageSize = -1)
        {
            RenRenResponseArg<VisitorsEntity> resp = await RequestById(uid, page, pageSize);
            return resp;
        }
        ...
        protected async override Task<RenRenResponseArg<VisitorsEntity>> DoRequest(params object[] args)
        {
            ...
            RenRenResponseArg<VisitorsEntity> resp = await API.Renren3GApi.GetVisitorList(seesionKey, secrectKey, page, pageSize);
            return resp;
        }
        ...
        protected async override Task<RenRenResponseArg<VisitorsEntity>> DoRequestById(int id, params object[] args)
        {
            ...
            int page = args.Length > 0 ? (int)args[0] : -1;
            int pageSize = args.Length > 1 ? (int)args[1] : -1;
            RenRenResponseArg<VisitorsEntity> resp = await API.Renren3GApi.GetVisitorList(seesionKey, secrectKey, id, page, pageSize);
            return resp;
        }
