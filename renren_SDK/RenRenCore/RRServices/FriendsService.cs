...
{
    class FriendsService : RRServiceBase<int, FriendListEntity>
    {
        /// <summary>
        /// Singleton property
        /// </summary>
        ...
        /// <returns></returns>
        public async Task<RenRenResponseArg<FriendListEntity>> RequestFriendListByUid(int uid, int page = -1, int pageSize = -1)
        {
            RenRenResponseArg<FriendListEntity> resp = await RequestById(uid, page, pageSize);
            return resp;
        }
        ...
        protected async override Task<RenRenResponseArg<FriendListEntity>> DoRequest(params object[] args)
        {
            ...
            RenRenResponseArg<FriendListEntity> resp = await API.Renren3GApi.GetFriendList(seesionKey, secrectKey);
            return resp;
        }
        ...
        protected async override Task<RenRenResponseArg<FriendListEntity>> DoRequestById(int id, params object[] args)
        {
            ...
            RenRenResponseArg<FriendListEntity> resp = await API.Renren3GApi.GetFriendList(seesionKey, secrectKey, id, page, pageSize);
            return resp;
        }
