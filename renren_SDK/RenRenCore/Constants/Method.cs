...
namespace RenrenCore.Constants
{
    internal static class Method
    {
        ...
        public static string AddWin8Token = "push.addWin8Token";
        ...
        public static string GetPoilistByEventId = "place.poiListByEventId";
        public static string SavePoiData = @"place.savePoiData";
        public static string NearbyActivityListByPid = @"place.nearbyActivityListByPid";
        public static string NearbyActivityListByLatLon = @"place.nearbyActivityListByLatLon";
        public static string SetIc = @"place.lc";
        public static string GetPoiCategory = @"place.getPoiCategory";

        public static string GetPoiBaseInfoByPid = @"place.getPoiBaseInfoByPid";
        public static string GetPoiBaseInfoByLbsId = @"place.getPoiBaseInfoByLbsId";
        public static string GetNearByRecommendPoiExtraList = @"place.getNearByRecommendPoiExtraList";
        public static string GetNearByFeeds = @"place.getNearByFeeds";
        public static string GetNearbyActivityNoticeCount = @"place.getNearbyActivityNoticeCount";
        public static string GetLocalCheckinListByPid = @"place.getLocalCheckinListByPid";

        public static string GetLocalActivityListByPid = @"place.getLocalActivityListByPid";
        public static string GetFeedsByPid = @"place.getFeedsByPid";

        public static string GetFeedListByPid = @"place.getFeedListByPid";

        public static string GetEvaluationComments = @"place.getEvaluationComments";
        public static string GetEvaluation = @"place.getEvaluation";

        public static string GetCheckinComments = @"place.getCheckinComments";

        public static string GetFriendList = @"place.friendList";

        public static string GeflectLatLon = @"place.deflectLatLon";

        public static string Checkin = @"place.checkin";

        public static string CalculateDistance = @"place.calculateDistance";

        public static string AddPoi = @"place.addPoi"; 

        public static string AddEvaluationComment = @"place.addEvaluationComment";

        public static string AddEvaluation = @"place.addEvaluation"; 

        public static string AddCheckinComment = @"place.addCheckinComment";

        public static string GetStaticMapByPid = @"place.getStaticMapByPid"; 
