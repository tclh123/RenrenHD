...
namespace RenrenCore.Apis
{
    ...
    {
        public async Task<RenRenResponseArg<UpdateInfoEntity>> GetUpdateInfo(string sessionKey, string secretKey)
        {
            ...
            var result = await agentReponseHandler<UpdateInfoEntity, RenRenResponseArg<UpdateInfoEntity>>(parameters, ConstantValue.PostMethod, new Uri("http://api.m.renren.com/api/"));
            return result;
        }
    }
}
