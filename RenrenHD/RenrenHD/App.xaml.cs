...
namespace RenrenHD
{
    ...
    {
        //oauth
        public static string api_key = @"e93b1564d61b41e494ca86dabc12febd";
        public static string SecretKey = @"0685e7b0c9a7467aad507504e2650534";

        public static string redirect_uri = @"https://login.renren.com/mlogin/code.jsp";
        ...
        public App()
        {
            ...
            scope.Add(@"place.poiList");
            scope.Add(@"place.friendList");
            scope.Add(@"place.getNearByFeeds");
            scope.Add(@"place.getNearbyActivityNoticeCount");
            scope.Add(@"Place.nearbyActivityListByLatLon");
            scope.Add(@"place.addPoi");
            scope.Add(@"place.getPoiCategory");
